...
export const strings = {
  ...
  talk: {
    ...
    thinking: "金孫想一下…",
    // 長輩按下麥克風之後才抵達的回覆一律丟棄（✅ 專案裁決 2026-07-31：按下麥克風
    // 的語意就是「我現在要講話，你先別說」，抵達時機是實作細節，長輩感受不到也
    // 不該感受到；而「十秒後金孫突然開始回答一個他已經放棄的問題」比沒有回答更
    // 讓人困惑——他不會記得自己問過那一句，只會覺得金孫在自言自語）。
    // ⚠️ 但**不可以靜默丟棄**：這句話讓長輩知道上一個問題不會有答案了，不必再等。
    thinkingAfterSkipped: "上一個問題就先跳過了，金孫想一下…",
