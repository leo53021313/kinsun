...
| 2026-08-02 | ⚠️ 待處理：`mohw_health_window`／`mohw_health_article`／`mohw_health_list` 三個來源實質無產出 | 實測三者收回來的全是「109年衛生福利部新聞」這類年度索引頁、零篇內文；`mohw_health_window` 的種子頁 `np-34-1.html` 標題雖是「衛教視窗」，整頁沒有任何文章連結。三者又同爬一個網域、跨來源去重先到先得，後兩者實際貢獻為零。與 HPA 四來源合併（2026-08-01）是同一種病，尚未處理。 |
