...
> **版本:** v1.2 | **更新:** 2026-07-10 | **狀態:** ✅ 定稿（會議決議已回填；§8 模組詳細設計隨架構文檔深化逐群補齊中）
...
> ✅ D-30 定案（會-1）：出站提醒**不查長輩同意**——`has_valid_consent` 檢查（用藥／回診長輩端）已於己-1 移除（2026-07-10），圖即現況。
...
| A-12 | `tools/health_rag.py` 無專屬測試（含 `should_escalate_to_risk_engine` 安全邏輯） | 群 1 深潛 2026-07-10 |
