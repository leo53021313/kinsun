...
> **版本:** v1.15 | **更新:** 2026-07-17 | **狀態:** ✅ 定稿（深化完成；庚批 2026-07-13 結案回填；locations／strategies／自適應問候時間已入圖；§8.5 補主動問候接續上次話題）
...
| CareAgent | 記憶組裝→LLM→工具迴圈（≤3 輪）→出站語音安全防線（JSON／fence 打撈，2026-07-17）→寫回（`agent.py`） | memory、llm、tools |
