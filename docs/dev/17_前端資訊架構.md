...
graph TB
    ...
    subgraph API["後端 /api/v1（信封 success/data/error/meta）"]
        ...
        ADM["admin：overview｜messages｜elders｜timeline｜traces"]
    end
...
**頁面總計**：App **10 頁**＋LIFF 4 頁（清單／用藥／回診／健康報告）＋admin 5 頁（總覽／訊息流／長輩／時間軸／鏈路詳情）。（2026-07-10 群 7 深潛更正：原記 9 頁，遺漏 `/guardian/notifications`；§3 全景圖於階段 F 重畫時補入。）
...
（LIFF 4 頁與 admin 5 頁規格從略——職責單一且已在 §3 圖示；admin 導航深度 3 已驗證。）
