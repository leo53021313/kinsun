...
> **版本:** v1.6 | **更新:** 2026-07-25 | **狀態:** ✅ 定稿（隨程式現況滾動更新）
...
| 原則 | 本專案落實 |
| :--- | :--- |
| 依賴倒置（DIP） | 44 個 Protocol＋三件套（Pg／Fake，18 組合約測試）；Service 依賴介面不依賴實作 |
...
graph TD
    ...
    subgraph 領域層
        ACC[accounts] & MED[medications] & APPT[appointments] & SAFE[safety] & MEM[memory] & RAG[rag] & REP[reports] & LOC[locations] & STRAT[strategies] & NEWS[news]
    end
    subgraph 基礎層
