...
| 07 | [模組規格與測試](07_模組規格與測試.md) | ✅ v1.19（News API 台灣媒體白名單＋生活話題關鍵字；D-74 消費端完成式；總測試 1517、合約 19 組） | 2026-07-25 |
...
| 14 | [部署與運維](14_部署與運維.md) | ✅ v1.10（NEWS_API_DOMAINS／QUERY 兩鍵；話題新聞清理與降級語意；Opik 服務；RAG Runbook） | 2026-07-25 |
