...
| # | 文件 | 狀態 | 最後更新 |
| :---: | :--- | :--- | :--- |
| 00 | [決策清單](00_決策清單.md) | ✅ D-01～D-75 全回填（D-38 掛起、4 項擱置；D-74 消費端完成；D-75 濫用審核採納並重寫接法，旗標依實測預設開） | 2026-07-25 |
...
| 05 | [架構與設計](05_架構與設計.md) | ✅ v1.33（§8.5 補濫用審核：三類越權／位置在家屬通報之後為安全屬性／誤攔防線三層；§12 離線評測四實驗；D-74 消費端） | 2026-07-25 |
| 06 | [API設計規範](06_API設計規範.md) | ✅ v1.4（新增 `GET /api/v1/admin/news` 話題新聞檢視，D-74） | 2026-07-25 |
| 07 | [模組規格與測試](07_模組規格與測試.md) | ✅ v1.26（safety 列補 AbuseModerator，6→7 檔；總測試 1572、合約 19 組；D-74 消費端完成式） | 2026-07-25 |
...
| 10 | [類別關係](10_類別關係.md) | ✅ v1.16（群 4 補 AbuseModerator／AbuseClassifier／ModerationResult，VoicePipeline 補選配 moderator；Protocol 47） | 2026-07-25 |
...
| 16 | [WBS開發計畫](16_WBS開發計畫.md) | ✅ v1.14（辛-10 濫用審核完成並依實測開啟旗標；RAG 個人庫驗收；甲～庚結案＋辛批 10 項；⚠ 庚-09 待 Leo 確認） | 2026-07-25 |
