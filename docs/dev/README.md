...
| # | 文件 | 狀態 | 最後更新 |
| :---: | :--- | :--- | :--- |
| 00 | [決策清單](00_決策清單.md) | ✅ D-01～D-74 全回填（D-38 掛起、4 項擱置；D-74 四項後續工項全結案＋消費端擴充完成） | 2026-07-25 |
...
| 05 | [架構與設計](05_架構與設計.md) | ✅ v1.32（D-74 消費端：get_news＋get_news_detail＋news_mentions 入 ER／資料分類；§12 工程觀測 Opik） | 2026-07-25 |
| 06 | [API設計規範](06_API設計規範.md) | ✅ v1.4（新增 `GET /api/v1/admin/news` 話題新聞檢視，D-74） | 2026-07-25 |
| 07 | [模組規格與測試](07_模組規格與測試.md) | ✅ v1.23（RSS 台媒來源＋Yahoo 台灣媒體名對映；News API sortBy 改 relevancy＋白名單後過濾＝Yahoo 台灣版；D-74 消費端完成式；總測試 1517、合約 19 組） | 2026-07-25 |
| 08 | [專案結構指南](08_專案結構指南.md) | ✅ v1.10（news/fetchers 補 rss.py；admin 八頁 NewsPage） | 2026-07-25 |
| 09 | [模組依賴關係](09_模組依賴關係.md) | ✅ v1.7（Protocol 45／合約 19；前端依賴對齊 audit 修復） | 2026-07-25 |
| 10 | [類別關係](10_類別關係.md) | ✅ v1.15（Protocol 44→45：NewsMentionStore；worker 13 job） | 2026-07-25 |
...
| 14 | [部署與運維](14_部署與運維.md) | ✅ v1.12（NEWS_RSS_FEEDS；NEWS_API_DOMAINS 改後過濾白名單；話題新聞清理與降級語意；Opik 服務；RAG Runbook） | 2026-07-25 |
...
| 17 | [前端資訊架構](17_前端資訊架構.md) | ✅ v1.10（admin 7 頁：D-74 話題新聞頁；對講機圓形麥克風鍵＋iOS 錄音修復） | 2026-07-25 |
