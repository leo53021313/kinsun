...
| 07 | [模組規格與測試](07_模組規格與測試.md) | ✅ v1.7（摘要穩健化＋agent 格式防線＋天氣縣市座標表＋稱謂注入；測試 1303／合約 17 組） | 2026-07-17 |
...
| 10 | [類別關係](10_類別關係.md) | ✅ v1.11（FactProvider 五段補齊、Elder 補 nickname；**42** Protocol 總表；三件套 17 組） | 2026-07-17 |
