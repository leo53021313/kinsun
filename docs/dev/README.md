...
| 12 | [前端架構規範](12_前端架構規範.md) | ✅ v1.10（D-76 統一行程元件現況；對講機 WS ack／reply／error、純文字降級狀態收尾與競態護欄） | 2026-07-30 |
...
| 16 | [WBS開發計畫](16_WBS開發計畫.md) | ✅ v1.28（辛-23 追加 WS 狀態、純文字 reply 收尾修正與回歸測試；保留辛-22 退化輸出修復、辛-21 一輪總預算、辛-20 定位修復、辛-19 非同步對講與辛-18 附近地點搜尋等 main 最新紀錄） | 2026-07-30 |
| 17 | [前端資訊架構](17_前端資訊架構.md) | ✅ v1.16（App 12／LIFF 3／admin 7；D-76 統一 `/schedules`；`/elder/notifications` 與對講機 WS 五態、純文字降級收尾契約） | 2026-07-30 |
