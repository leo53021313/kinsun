...
| 05 | [架構與設計](05_架構與設計.md) | ✅ v1.40（as-is 更新：§8.1 新增 voice_profiles 長輩客製化聲音複製，/synthesize 契約擴充選填 elder_id／prompt_audio_url／prompt_text、向下相容；家屬上傳／同意 UX 未建置、未經拍板不入 00；前次：統一排程 D-76 五刀全完成） | 2026-07-30 |
...
| 07 | [模組規格與測試](07_模組規格與測試.md) | ✅ v1.31（as-is 更新：新增 voice_profiles 長輩客製化聲音複製模組，合約 19 組、總測試 1744；未經拍板不入 00；前次：統一排程五刀全完成、舊模組退役、D-74 消費端完成式） | 2026-07-30 |
...
| 09 | [模組依賴關係](09_模組依賴關係.md) | ✅ v1.9（新增 voice_profiles，Protocol 47→48／合約 19；未經拍板不入 00） | 2026-07-30 |
| 10 | [類別關係](10_類別關係.md) | ✅ v1.21（新增 VoiceProfileStore／VoiceReference，VoicePipeline 補選配 voice_profiles；Protocol 47→48；未經拍板不入 00） | 2026-07-30 |
