...
| 05 | [架構與設計](05_架構與設計.md) | ✅ v1.14（§8.5 補接續上次話題；summarize_day 穩健化：文字稿輸入＋重試＋清洗） | 2026-07-17 |
| 06 | [API設計規範](06_API設計規範.md) | ✅ v1.1（turns 位置參數；錯誤碼中央註冊 庚-25） | 2026-07-17 |
| 07 | [模組規格與測試](07_模組規格與測試.md) | ✅ v1.4（摘要穩健化：文字稿輸入＋重試＋清洗驗收；測試 1279／合約 17 組） | 2026-07-17 |
