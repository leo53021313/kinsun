...
| 05 | [架構與設計](05_架構與設計.md) | ✅ v1.22（§12 工程觀測 Opik 全鏈路 span＋排程/批次 trace root；併入 RAG 版本發布、Discovery 隔離、檢索邊界與結構閘門） | 2026-07-19 |
| 06 | [API設計規範](06_API設計規範.md) | ✅ v1.2（稱謂欄位：POST /elders 收 nickname、新增 PUT /elders/{elder_id}/profile） | 2026-07-17 |
| 07 | [模組規格與測試](07_模組規格與測試.md) | ✅ v1.12（§2.3 空辨識守門擴及純標點幻覺；併入 RAG 23 模組、版本化檢索契約與測試 1374 項） | 2026-07-19 |
| 08 | [專案結構指南](08_專案結構指南.md) | ✅ v1.4（補工程觀測 tracing/ 與頂層 evals/；併入 RAG 發布、遷移、評估、Worker 與回滾模組） | 2026-07-19 |
