...
| 05 | [架構與設計](05_架構與設計.md) | ✅ v1.31（get_news 工具入 tools 節點；話題新聞 D-74：Worker jobs＋ER＋資料分類；§12 工程觀測 Opik） | 2026-07-25 |
...
| 07 | [模組規格與測試](07_模組規格與測試.md) | ✅ v1.17（get_news 工具入 tools 列，總測試 1492；話題新聞 news 列＋合約 18 組） | 2026-07-25 |
| 08 | [專案結構指南](08_專案結構指南.md) | ✅ v1.7（tools/ 補 news.py；後端樹補 news/） | 2026-07-25 |
