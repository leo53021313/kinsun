...
| 07 | [模組規格與測試](07_模組規格與測試.md) | ✅ v1.22（Yahoo 台灣媒體名對映；News API sortBy 改 relevancy＋白名單後過濾＝Yahoo 台灣版；D-74 消費端完成式；總測試 1517、合約 19 組） | 2026-07-25 |
| 08 | [專案結構指南](08_專案結構指南.md) | ✅ v1.9（admin 八頁 NewsPage；news/ 補 mentions.py） | 2026-07-25 |
...
| 14 | [部署與運維](14_部署與運維.md) | ✅ v1.11（NEWS_API_DOMAINS 改後過濾白名單；話題新聞清理與降級語意；Opik 服務；RAG Runbook） | 2026-07-25 |
