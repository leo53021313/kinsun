...
| 13 | [安全與就緒檢查](13_安全與就緒檢查.md) | ✅ v1.5（新增工具寫入授權與語音後端誤設兩列；日誌脫敏需重驗；§G 補外呼逾時與 D-22 部分落地；位置隱私列；依賴掃描與 healthz 結案） | 2026-07-27 |
