...
| 05 | [架構與設計](05_架構與設計.md) | ✅ v1.13（庚批結案回填＋locations／strategies／自適應問候時間入圖；§8.5 補接續昨天話題） | 2026-07-17 |
| 06 | [API設計規範](06_API設計規範.md) | ✅ v1.1（turns 位置參數；錯誤碼中央註冊 庚-25） | 2026-07-17 |
| 07 | [模組規格與測試](07_模組規格與測試.md) | ✅ v1.3（新增 locations／strategies／turn_context；測試 1259／合約 17 組；D-33 摘要現況已失效） | 2026-07-17 |
...
| 10 | [類別關係](10_類別關係.md) | ✅ v1.10（**42** Protocol 總表；三件套 17 組；ConversationSummaryStore 補 get_for_date） | 2026-07-17 |
