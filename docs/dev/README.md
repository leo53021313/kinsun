...
| 05 | [架構與設計](05_架構與設計.md) | ✅ v1.20（§12 工程觀測 Opik——全鏈路 span 盤點＋排程/批次 trace root） | 2026-07-19 |
| 06 | [API設計規範](06_API設計規範.md) | ✅ v1.2（稱謂欄位：POST /elders 收 nickname、新增 PUT /elders/{elder_id}/profile） | 2026-07-17 |
| 07 | [模組規格與測試](07_模組規格與測試.md) | ✅ v1.10（§2.3 空辨識守門擴及純標點幻覺；測試 1317／合約 17 組） | 2026-07-18 |
| 08 | [專案結構指南](08_專案結構指南.md) | ✅ v1.3（補工程觀測 tracing/ 與頂層 evals/） | 2026-07-19 |
...
| 14 | [部署與運維](14_部署與運維.md) | ✅ v1.4（Opik 公開隧道遠端檢視 kinsun.sh start/stop opik） | 2026-07-19 |
...
| 17 | [前端資訊架構](17_前端資訊架構.md) | ✅ v1.9（對講機改圓形麥克風鍵＋回覆可捲動；iOS 錄音修復＋內測權限列） | 2026-07-18 |
