...
> **版本:** v1.2 | **更新:** 2026-07-10 | **狀態:** ✅ 定稿（會議決議已回填；D-72 三級制已隨己-4 落地，L2 為頂級）
...
Feature: 危急偵測分級與通知
  ...
  Scenario: 絕對危急詞觸發頂級警訊
    # ✅ D-72（己-4，2026-07-10）：三級制——絕對危急詞記 L2（頂級）
    When 阿蘭說「救命」
    Then 應記錄一筆頂級危急事件（L2）
...
> 2026-07-09 會議決議回填：@pending-decision 全數清零（D-10／13／09／30／31 已定案改寫；fail-safe 併 D-31）。✅ D-72 三級制用語已於己-4 全檔同步（2026-07-10）。
