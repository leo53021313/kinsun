...
建立 `web/src/stage/StagePage.tsx`：
...
import { createSessionContext } from "@/session/createSessionContext";
import { strings } from "@/strings";
...
```bash
git add web/src/stage/StagePage.tsx web/src/stage/StagePage.test.tsx \
