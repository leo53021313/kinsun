...
Run: `uv run pytest tests/test_places_categories.py -v`
Expected: PASS（29 passed，2026-07-28 新增 exclude_overture 機制後更新——含
chiropractic 4 個正面案例、6 個反面案例，另補 pharmacy require_keyword、temple
花壇、NFKC 全形連字號、temple exclude_overture 否決權（含刻意保留 lodging／
restaurant／delicatessen 不擋、守住北港朝天宮等真廟不被誤殺）等測試）
