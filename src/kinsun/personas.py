"""陪伴角色「阿白」的人設目錄：唯一真實來源。

⚠️ **角色叫阿白，「金孫」是服務名**（2026-08-07 新視覺定案，2026-08-12 補齊本檔）：
本檔的 `tone` 是長輩對話時模型讀到的**身分宣告**，必須用角色名。品牌字樣、App 名稱、
同意條款主體、推播標題那些才是服務名，維持「金孫」不動。兩者混用的後果見
`tests/test_personas.py::test_tone_declares_the_character_name_not_the_service_name`。
