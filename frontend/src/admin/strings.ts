...
export const strings = {
  ...
  elderTabs: {
    ...
    reminders: {
      ...
      medicationHeading: "用藥設定",
      noMedications: "尚未設定用藥。",
      slotsPrefix: "時段：",
      sendSlotButton: (slotLabel: string) => `立即發送${slotLabel}提醒（內測）`,
      appointmentHeading: "回診設定",
      noAppointments: "尚未設定回診。",
      sendAppointmentButton: "立即發送今明兩天回診提醒（內測）",
